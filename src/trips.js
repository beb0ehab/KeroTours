...
export const TRIPS = {
  sea: [
    { name: '🚤 Private Speedboat', price: 'From €135', unit: 'Up to 5 persons', duration: '4 hours', badge: 'Most Popular', options: true, items: ['Wild dolphin watching', 'White Island visit', 'Snorkeling included'], note: M5, img: 't-speedboat.jpg' },
    ...
    { name: '🐬 Dolphin House Boat', price: '€25', unit: 'Per adult (shared)', duration: '7–8 hours', items: ['Wild dolphin swimming', 'Two snorkeling stops', 'Buffet lunch & drinks'], note: M5, img: 't-dolphinhouse.jpg' },
  ...
  historical: [
    { name: '🇪🇬 Cairo Historical Trip', price: '€100', unit: 'Per adult (Fri & Sun shared)', duration: '~20 hours (1:30am–10pm)', badge: 'Must Do', options: true, items: ['Giza Pyramids & Sphinx', 'Grand Egyptian Museum', 'Tutankhamun collection'], note: M5, img: 't-cairohist.jpg' },
    { name: '🏛️ Luxor Historical Trip', price: '€80', unit: 'Per person (Tue & Thu shared)', duration: '~16.5 hours (4:30am–9pm)', options: true, items: ['Karnak Temple', 'Valley of the Kings', 'Hatshepsut Temple'], note: M5, img: 't-luxorhist.jpg' }
  ]
};
